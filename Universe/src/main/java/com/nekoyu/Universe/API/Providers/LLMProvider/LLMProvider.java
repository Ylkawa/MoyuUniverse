...
public abstract class LLMProvider extends Provider {
     ...
     * 生成 LLM 回复
     */
    public abstract CompletionsResponse completions(String model, Context context, List<LLMFunction> llmTools, LLMOptions LLMOptions, BufferCallback bufferCallback) throws IOException;
